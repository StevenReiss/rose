...
BushProblem(BumpStackFrame frame,RoseProblemType typ,String item,String orig,String tgt)
{
   super(typ,item,orig,tgt);
   stack_frame = frame;
}
...
{
   xw.field("FRAME",getFrame().getId());
   xw.field("THREAD",getThread().getId());
}
